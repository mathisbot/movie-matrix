...
const VoteSlider = ({
  ...
  const adjectiveMap: { [key: number]: string } = {
    1: "Appalling",
    2: "Horrible",
    3: "Very Bad",
    4: "Bad",
  ...
  return (
    <div className="my-3 flex flex-row items-center content-center">
      <div className="flex flex-row items-center space-x-4 h-full content-center justify-between mx-4">
        ...
        />
        <p className="text-center w-32">{adjectiveMap[value]}</p>
      </div>
